 ...
 * @author User
 */
public class buildingLogin extends javax.swing.JFrame {

    /**
     * Creates new form buildingLogin
     */
    public buildingLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("(Building Executive)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buildingLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buildingLogin().setVisible(true);
            }
        });
    }
