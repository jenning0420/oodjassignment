 ...
 * @author User
 */
public class managerViewVisitorPassReport extends javax.swing.JFrame {
     ...
     */
    public managerViewVisitorPassReport() throws IOException {
        initComponents();
        
        File f = new File("src/textFiles/visitorPassReport.txt");
        if (!f.exists()) {
            f.createNewFile();
        }
    ...
    private void getData() {
        try {
            File file = new File("src/textFiles/visitorPassReport.txt");
            ...
            JOptionPane.showMessageDialog(null, "File not found: visitorPassReport");
        }
    }
    ...
    private void generate() {
        ...
        File destinationFile = new File("src/textFiles/visitorPassReport.txt");
    ...
    private void visitorPassReport(){
        frame = new JFrame("Generate Report");
        if (JOptionPane.showConfirmDialog(frame, "Are you sure to GENERATE Visitor Pass Report?", "Generate Report",
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Visitor Pass Report");
        ...
        jLabel9.setText("Visit Duration");
        ...
        jLabel11.setText("Total Number of Visitor Pass Generated:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managerViewVisitorPassReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(managerViewVisitorPassReport.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
