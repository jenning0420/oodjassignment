 ...
 * @author User
 */
public class managerViewVisitorEntryReport extends javax.swing.JFrame {

    private javax.swing.JLabel[] patrol, user, venue, details, date, time;

    /**
     * Creates new form buildingViewJobReport
     */
    public managerViewVisitorEntryReport() throws IOException {
        initComponents();
        
        File f = new File("src/textFiles/visitorEntryReport.txt");
        if (!f.exists()) {
            f.createNewFile();
        }
    ...
    private void getData() {
        try {
            File file = new File("src/textFiles/visitorEntryReport.txt");
            ...
            JOptionPane.showMessageDialog(null, "File not found: visitorEntryReport");
        }
    }
    ...
    private void generate() {
        ...
        File destinationFile = new File("src/textFiles/visitorEntryReport.txt");
    ...
    private void visitorEntryReport(){
        frame = new JFrame("Generate Report");
        if (JOptionPane.showConfirmDialog(frame, "Are you sure to GENERATE Visitor Entry Report?", "Generate Report",
            ...
            try {
                ...
                Logger.getLogger(managerViewVisitorEntryReport.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Visitor Entry Report");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel21, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel11.setText("Total Number of Entries:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managerViewVisitorEntryReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
