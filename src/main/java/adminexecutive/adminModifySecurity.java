 ...
 * @author User
 */
public class adminModifySecurity extends javax.swing.JFrame {

    /**
     * Creates new form adminModifySecurity
     */
    public adminModifySecurity() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Modify Security Guards");
        ...
        empType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Security Guard" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminModifySecurity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
