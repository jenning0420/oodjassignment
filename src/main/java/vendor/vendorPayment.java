...
public class vendorPayment extends javax.swing.JFrame {
    ...
    public vendorPayment() {
        ...
        try {
            ...
            Logger.getLogger(vendorPayment.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vendor Payment Page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vendorPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
